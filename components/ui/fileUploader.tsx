...
const FileUploaderContext = createContext<FileUploaderContextType | null>(
  null
);
...
export const FileUploadDropzone = () => {
  ...
  const dropzone = {
    accept: {
      'image/*': ['.jpg', '.jpeg', '.png', '.pdf', 'mov', '.mp4', '.mp3']
    },
    multiple: true,
    maxFiles: 10,
    maxSize: 1 * 1024 * 1024
  ...
  return (
    ...
    >
      ...
      <FileUploaderContent className='flex w-full flex-row flex-wrap items-center gap-2'>
        {files?.map((file, i) => (
          <FileUploaderItem
            key={i}
            index={i}
            className='size-28 overflow-hidden rounded-md p-0'
